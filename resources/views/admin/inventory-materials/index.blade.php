<x-admin-layout>
    ...
    <div class="admin-toolbar">
        <div>
            ...
            <p class="admin-page-desc">Saldo stok, minimum stok, dan status LOW/OK untuk referensi RFQ.</p>
        </div>
    ...
    <div class="admin-table-wrap">
        <table class="admin-table">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="py-8 text-center text-slate-500">Belum ada data material inventory.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
